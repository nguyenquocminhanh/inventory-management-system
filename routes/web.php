...
Route::controller(DefaultController::class)->group(function () {
    ...
    Route::get('/check-product-stock', 'CheckProductStock')->name('check-product-stock');
});
...
Route::middleware('auth', 'verified')->group(function () {
    ...
    Route::controller(CustomerController::class)->group(function () {
        ...
        // detail customer due invoice
        Route::get('/customer/detail/invoice/{id}', 'CustomerInvoiceDetail')->name('customer.invoice.detail.pdf');
    ...
    Route::controller(PurchaseController::class)->group(function () {
        ...
        // print Purchase
        Route::get('/purchase/print/list', 'PurchasePrintList')->name('purchase.print.list');
        Route::get('/purchase/print/{id}', 'PrintPurchase')->name('purchase.print');
